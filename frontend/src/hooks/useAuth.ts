...
export function useAuth() {
  const [token, setToken] = useState<string | null>(() => localStorage.getItem('chatty_token') || sessionStorage.getItem('chatty_token'));
  const [username, setUsername] = useState<string | null>(() => localStorage.getItem('chatty_username') || sessionStorage.getItem('chatty_username'));
